<?php // time ago units settings class


if ( !defined('ABSPATH') ) exit;

class Time_Ago_Units_Settings {

  public function __construct(){
    // add Time Ago Units Settings submenu
    add_action( 'admin_menu', array( $this , 'time_ago_units_settings_menu' ) );
    add_action( 'admin_init', array( $this , 'time_ago_units_register_settings' ) );
  ...
  public function time_ago_units_register_settings() {
    ...
    add_settings_section(
      ...
      'General Settings',
      array( $this , 'time_ago_units_section_callback' ),
      'time_ago_units'
    );
    add_settings_field(
      'time_ago_units_display_type',
      'Time Ago Units Display Units',
      array( $this , 'time_ago_units_settings_callback' ),
      'time_ago_units',
      'time_ago_units_section_general',
      array( 'id' => 'time_ago_units_display_type' , 'label' => 'Choose the Time Ago starting unit' )
    );
  }

  public function time_ago_units_default_settings() {
    return array ( 'time_ago_units_display_type' => 'default' );
  }
  ...
  public function time_ago_units_settings_menu() {
    add_submenu_page(
        ...
        'manage_options',
        'time_ago_units',
        array($this, 'time_ago_units_settings_page_html')
    );
  }
